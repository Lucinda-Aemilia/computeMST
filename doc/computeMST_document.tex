...
\part{Introduction}
    ...
    \chapter{Purpose}
        ...
        This software design document describes the architecture and system design of project ComputeMST. This is a homework of Fundamentals of Object-Oriented Programming class. The homework requirement is as follows:
    ...
    \chapter{Scope}
        ...
        I implemented the first six requirements of the homework, mainly using CGAL and Kruskal's MST algorithm.
...
\chapter{System Architecture}
    ...
    \chapter{Architectural Design} % 将整个系统划分为功能模块，介绍每个模块之间的功能和相互关系
        ...
        The program can be divided into two parts: the computational part and the display part. The computational part 
